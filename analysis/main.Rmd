...
p1 <-ggplot(donors_contrib, aes(x = fct_reorder(donor, pct), y = pct)) +
  ...
  scale_x_discrete(name = NULL,
                   expand = c(0, 0.5)) +
  labs(title = "Contributions frequency (from total)",
       subtitle = "WASH contributions for Viet Nam and Bangladesh") +
  coord_flip(clip = "off") +
...
# Bar plot
p1 <- ggplot(donors_ranking_amount, aes(x = fct_reorder(donor, pct), y = pct)) +
  geom_col(fill = "#22577a", alpha = 0.9) +
  scale_y_continuous(
    expand = c(0, 0.7),
    breaks = seq(0, 30, 2),
  ...
  scale_x_discrete(name = NULL,
                   expand = c(0, 0.5)) +
  labs(title = "Contributions amount (from total)",
       subtitle = "WASH amount contributions for Viet Nam and Bangladesh") +
  coord_flip(clip = "off") +
  theme_dviz_vgrid(rel_small = .7) +
  theme(
    axis.ticks.length = grid::unit(0, "pt"),

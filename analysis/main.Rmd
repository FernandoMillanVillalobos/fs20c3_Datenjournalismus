...
p1 <-ggplot(donors_contrib, aes(x = fct_reorder(donor, pct), y = pct)) +
  ...
  scale_x_discrete(name = NULL,
                   expand = c(0, 0.5)) +
  labs(title = "Frequency contributions (from total)",
...
p2 <- ggplot(donors_contrib_per_recipient, aes(x = fct_reorder(recipient, desc(pct)), y = pct)) +
  ...
  scale_x_discrete(name = NULL,
                   expand = c(0, .5, .5, 2)) +
  labs(title = "Total donor´s contributions per recipient",
...
p3 <- ggplot(donors_contrib_per_donor_recipient, aes(x = count, fill = recipient)) + 
  ...
  labs(title = "Total donor´s contributions density per recipient") +
  theme_dviz_hgrid() +
  theme(
...
p5 <- ggplot(donors_contrib_timeline_recipient, aes(x = year, y = count, color = recipient)) + 
  ...
  scale_color_manual(
    ...
    name = NULL) +
  labs(
    title = "Donor´s contributions timeline per recipient") +
  theme_dviz_open() +
  theme(
